import 'payment_checkout_online_data_source.dart';
...
class PaymentCheckoutOnLineDataSourceImpl
    implements PaymentCheckoutOnLineDataSource {
  ...
  Future<Result<PaymentCheckoutResponse?>> getPaymentCheckout(
    ...
    return executeApi(() async {
      var response =
          await _homeRetrofit.getPaymentCheckout(paymentRequest, token);
      return response;
    });
  }
}
