...
class ChangePasswordUseCase{
  ...
  Future<Result<ChangePasswordEntity?>> invoke(String  oldPassword,String  newPassword,String rePassword,String token){
    return changePasswordRepository.changePassword(oldPassword,newPassword,rePassword,token);
  }
}
