...
class _ApiService implements ApiService {
  ...
  Future<OccasionResponse?> getOccasions() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OccasionResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(_options);
    late OccasionResponse? _value;
    try {
      _value = _result.data == null
          ? null
          : OccasionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<EditProfile> editProfile(
    ...
    final _options = _setStreamType<EditProfile>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late EditProfile _value;
    try {
      _value = EditProfile.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AddToCartResModel?> addProductToCart(
    ...
    try {
      _value = _result.data == null
          ? null
          : AddToCartResModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<AddressResponse?> getUserAddresses(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<PaymentCheckoutResponse> getPaymentCheckout(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(paymentCheckoutRequest.toJson());
    final _options = _setStreamType<PaymentCheckoutResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PaymentCheckoutResponse _value;
    try {
      _value = PaymentCheckoutResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CashOrderResponse> getCashOrder(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(paymentCheckoutRequest.toJson());
    final _options = _setStreamType<CashOrderResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CashOrderResponse _value;
    try {
      _value = CashOrderResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
