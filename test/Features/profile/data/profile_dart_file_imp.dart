...
void main() {
  test(
    'Verify that invoking getOccasions on OccasionRepoImpl correctly triggers the getOccasions method of OccasionOnLineDataSource',
      ...
      var result = Success<ProfileEntity?>(ProfileEntity()); // Adjust based on your actual Success class.

      // Stubbing the method call
      when(onlineDataSource.getProfileData("token")).thenAnswer((_) async => result);
